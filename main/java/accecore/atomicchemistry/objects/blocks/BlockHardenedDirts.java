...
public class BlockHardenedDirts extends Block implements IMetaName, IHasModel
{
	...
	public BlockHardenedDirts(String name) 
	{
		super(Material.ROCK);
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "dirt_hardened_" + EnumHandler.EnumTypeMaterials.values()[i].getName(), "inventory");
		}
	}
}