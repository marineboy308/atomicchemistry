...
public class BlockMicroscope extends Block implements IHasModel {
	
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public static final AxisAlignedBB AABB_X = new AxisAlignedBB(0.3125D, 0, 0.1875D, 0.6875D, 0.75D, 0.8125D);
	public static final AxisAlignedBB AABB_Z = new AxisAlignedBB(0.1875D, 0, 0.3125D, 0.8125D, 0.75D, 0.6875D);

	public BlockMicroscope(String name, Material material) {
		super(material);
